...
// Project 5 - Open Hashing (aka hashing by chaining)
// E-mail: amahadev@worcester.edu

// Description:
//    In this assignment (part I1) we implement the hashing
//    with chaining which is an implementation
...
public class OpenHashingDriver {
    public static void main (String args[]) {
       String line;
       Book element;
       OpenHashing <Book> ht = new OpenHashing <Book> ();
       ...
       try {
           ...
           PrintWriter out = new PrintWriter(
        		    new FileWriter("OpenHashing_Output.txt"));
